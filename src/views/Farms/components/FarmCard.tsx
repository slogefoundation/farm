...
import { Button, Flex, Image, Link } from '@wdefifinancebsc/uikit'
  ...
  return (
    <FCard>
      ...
      <Label>
        ...
        <span className="right">{farm.dual ? farm.dual.earnLabel : 'wDEFI'}</span>
      </Label>
      {!removed && (
        <Label>
     ...
     {!removed && (
      ...
      <ViewMore>
        <Link
          href={`https://bscscan.com/address/${farm.lpAddresses[2000]}`}
          external
          m="auto"
        >
